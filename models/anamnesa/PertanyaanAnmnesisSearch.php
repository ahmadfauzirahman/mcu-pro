...
/**
 * PertanyaanAnmnesisSearch represents the model behind the search form of `app\models\anamnesa\PertanyaanAnmnesis`.
 */
class PertanyaanAnmnesisSearch extends PertanyaanAnmnesis
{
    /**
     * {@inheritdoc}
     */
