 ...
 * @property string|null $tl_test_garpu_tala_periksa
...
class SpesialisTht extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tl_test_garpu_tala_periksa' => 'Tl Test Garpu Tala Periksa',
            'tl_test_berbisik_periksa' => 'Tl Test Berbisik Periksa',
