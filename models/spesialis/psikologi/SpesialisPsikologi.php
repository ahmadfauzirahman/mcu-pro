...
class SpesialisPsikologi extends BaseAR
{
    ...
    public function rules()
    {
        return [
            ...
            [['rp_diagnosa_dokter', 'rp_keluhan_fisik', 'rp_keluhan_psikologis', 'asesmen_observasi_du_penampilan_umum', 'asesmen_observasi_du_sikap_terhadap_pemeriksa', 'asesmen_observasi_du_afek', 'asesmen_observasi_du_roman_muka', 'asesmen_observasi_du_proses_pikir', 'asesmen_observasi_du_gangguan_persepsi', 'asesmen_observasi_fp_kognitif_memori', 'asesmen_observasi_fp_kognitif_konsentrasi', 'asesmen_observasi_fp_kognitif_orientasi', 'asesmen_observasi_fp_kognitif_kemampuan_verbal', 'asesmen_observasi_fp_kognitif_emosi', 'asesmen_observasi_fp_kognitif_perilaku'], 'string', 'max' => 30],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'dokter' => 'Dokter',
            'rp_diagnosa_dokter' => 'Rp Diagnosa Dokter',
            'rp_keluhan_fisik' => 'Rp Keluhan Fisik',
            'rp_keluhan_psikologis' => 'Rp Keluhan Psikologis',
            'asesmen_observasi_du_penampilan_umum' => 'Asesmen Observasi Du Penampilan Umum',
            'asesmen_observasi_du_sikap_terhadap_pemeriksa' => 'Asesmen Observasi Du Sikap Terhadap Pemeriksa',
            'asesmen_observasi_du_afek' => 'Asesmen Observasi Du Afek',
            'asesmen_observasi_du_roman_muka' => 'Asesmen Observasi Du Roman Muka',
            'asesmen_observasi_du_proses_pikir' => 'Asesmen Observasi Du Proses Pikir',
            'asesmen_observasi_du_gangguan_persepsi' => 'Asesmen Observasi Du Gangguan Persepsi',
