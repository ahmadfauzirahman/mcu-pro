...
namespace app\models\spesialis\tradmill;
 ...
 */
class SpesialisTreadmill extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['no_daftar', 'permintaan', 'metode', 'lama_latihan', 'test_dihentikan_karena', 'dj_maksimal', 'td_maksimal', 'ekg_istirahat', 'ekg_latihan', 'ekg_pemulihan', 'tingkat_kesegaran_jasmani', 'kelas_fungsional', 'kapasitas_aerobik', 'respon_hemodinamik', 'respon_iskemik', 'anjuran', 'riwayat', 'kesan', 'status_pemeriksaan', 'td_minimal'], 'string'],
