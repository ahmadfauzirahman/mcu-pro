 ...
 * @property string|null $kesan_dokter_umum
 * @property string|null $hemoroid
 * @property string|null $hemoroid_lainnya
 * @property string|null $hydrocele
 * @property string|null $varicocele
 * @property string|null $ulceral
...
class MPemeriksaanFisik extends BaseAR
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'sistolik' => 'Sistolik',
            'diastolik' => 'Diastolik',
            'mata_visus_tanpa_koreksi_kiri' => 'Mata Visus Tanpa Koreksi Kiri',
            'mata_visus_dengan_koreksi_kiri' => 'Mata Visus Dengan Koreksi Kiri',
            'id_dokter_fit_for_work' => 'Id Dokter Fit For Work',
            'kesan_dokter_umum' => 'Kesan Dokter Umum',
            'hemoroid' => 'Hemoroid',
            'hemoroid_lainnya' => 'Hemoroid Lainnya',
            'hydrocele' => 'Hydrocele',
            'varicocele' => 'Varicocele',
            'ulceral' => 'Ulceral',
            'gonorchoea' => 'Gonorchoea',
            'genitalia_lainnya' => 'Genitalia Lainnya',
        ];
    }
}
