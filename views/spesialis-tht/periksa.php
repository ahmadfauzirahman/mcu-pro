...
/* @var $model app\models\spesialis\SpesialisTht */
                ...
                window.location = baseUrl + 'spesialis-tht/periksa?id=' + e.params.data.id
                    ...
                    <table class="table table-sm tabel-tht">
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_daun_telinga_kanan',  ['id' => 'spesialistht_tl_daun_telinga_kanan_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_daun_telinga_kanan == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_tl_daun_telinga_kanan_1" name="SpesialisTht[tl_daun_telinga_kanan]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_daun_telinga_kiri',  ['id' => 'spesialistht_tl_daun_telinga_kiri_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_daun_telinga_kiri == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_tl_daun_telinga_kiri_1" name="SpesialisTht[tl_daun_telinga_kiri]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_liang_telinga_kanan',  ['id' => 'spesialistht_tl_liang_telinga_kanan_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_liang_telinga_kanan == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_tl_liang_telinga_kanan_1" name="SpesialisTht[tl_liang_telinga_kanan]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_liang_telinga_kiri',  ['id' => 'spesialistht_tl_liang_telinga_kiri_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_liang_telinga_kiri == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_tl_liang_telinga_kiri_1" name="SpesialisTht[tl_liang_telinga_kiri]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_serumen_telinga_kanan',  ['id' => 'spesialistht_tl_serumen_telinga_kanan_0', 'value' => 'Tidak Ada', 'label' => 'Tidak Ada']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_serumen_telinga_kanan == 'Ada Serumen') ? 'checked' : null ?> type="radio" id="spesialistht_tl_serumen_telinga_kanan_1" name="SpesialisTht[tl_serumen_telinga_kanan]" value="Ada Serumen">
                                    Ada Serumen
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_serumen_telinga_kiri',  ['id' => 'spesialistht_tl_serumen_telinga_kiri_0', 'value' => 'Tidak Ada', 'label' => 'Tidak Ada']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_serumen_telinga_kiri == 'Ada Serumen') ? 'checked' : null ?> type="radio" id="spesialistht_tl_serumen_telinga_kiri_1" name="SpesialisTht[tl_serumen_telinga_kiri]" value="Ada Serumen">
                                    Ada Serumen
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_serumen_telinga_kanan == 'Menyumbat (Prop)') ? 'checked' : null ?> type="radio" id="spesialistht_tl_serumen_telinga_kanan_2" name="SpesialisTht[tl_serumen_telinga_kanan]" value="Menyumbat (Prop)">
                                    Menyumbat (Prop)
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_serumen_telinga_kiri == 'Menyumbat (Prop)') ? 'checked' : null ?> type="radio" id="spesialistht_tl_serumen_telinga_kiri_2" name="SpesialisTht[tl_serumen_telinga_kiri]" value="Menyumbat (Prop)">
                                    Menyumbat (Prop)
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_membrana_timpani_telinga_kanan',  ['id' => 'spesialistht_tl_membrana_timpani_telinga_kanan_0', 'value' => 'Intak', 'label' => 'Intak']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_membrana_timpani_telinga_kanan == 'Tidak Intak') ? 'checked' : null ?> type="radio" id="spesialistht_tl_membrana_timpani_telinga_kanan_1" name="SpesialisTht[tl_membrana_timpani_telinga_kanan]" value="Tidak Intak">
                                    Tidak Intak
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_membrana_timpani_telinga_kiri',  ['id' => 'spesialistht_tl_membrana_timpani_telinga_kiri_0', 'value' => 'Intak', 'label' => 'Intak']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_membrana_timpani_telinga_kiri == 'Tidak Intak') ? 'checked' : null ?> type="radio" id="spesialistht_tl_membrana_timpani_telinga_kiri_1" name="SpesialisTht[tl_membrana_timpani_telinga_kiri]" value="Tidak Intak">
                                    Tidak Intak
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_membrana_timpani_telinga_kanan == 'Lainnya') ? 'checked' : null ?> type="radio" id="spesialistht_tl_membrana_timpani_telinga_kanan_2" name="SpesialisTht[tl_membrana_timpani_telinga_kanan]" value="Lainnya">
                                    Lainnya
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_membrana_timpani_telinga_kiri == 'Lainnya') ? 'checked' : null ?> type="radio" id="spesialistht_tl_membrana_timpani_telinga_kiri_2" name="SpesialisTht[tl_membrana_timpani_telinga_kiri]" value="Lainnya">
                                    Lainnya
                                </label>
                            </td>
                        </tr>
                        ...
                        <tr class="tr_test_garpu_tala" style="<?= $model->tl_test_garpu_tala_periksa == 'Tidak' ? 'display: none' : null ?>">
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_test_garpu_tala_rinne_telinga_kanan',  ['id' => 'spesialistht_tl_test_garpu_tala_rinne_telinga_kanan_0', 'value' => 'Negatif (AC < BC)', 'label' => 'Negatif (AC < BC)']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_test_garpu_tala_rinne_telinga_kanan == 'Positif (AC > BC)') ? 'checked' : null ?> type="radio" id="spesialistht_tl_test_garpu_tala_rinne_telinga_kanan_1" name="SpesialisTht[tl_test_garpu_tala_rinne_telinga_kanan]" value="Positif (AC > BC)">
                                    Positif (AC > BC)
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_test_garpu_tala_rinne_telinga_kiri',  ['id' => 'spesialistht_tl_test_garpu_tala_rinne_telinga_kiri_0', 'value' => 'Negatif (AC < BC)', 'label' => 'Negatif (AC < BC)']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_test_garpu_tala_rinne_telinga_kiri == 'Positif (AC > BC)') ? 'checked' : null ?> type="radio" id="spesialistht_tl_test_garpu_tala_rinne_telinga_kiri_1" name="SpesialisTht[tl_test_garpu_tala_rinne_telinga_kiri]" value="Positif (AC > BC)">
                                    Positif (AC > BC)
                                </label>
                            </td>
                        </tr>
                        <tr class="tr_test_garpu_tala" style="<?= $model->tl_test_garpu_tala_periksa == 'Tidak' ? 'display: none' : null ?>">
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_weber_telinga_kanan',  ['id' => 'spesialistht_tl_weber_telinga_kanan_0', 'value' => 'Tidak Ada Lateralisasi', 'label' => 'Tidak Ada Lateralisasi']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_weber_telinga_kanan == 'Lateralisasi Kanan') ? 'checked' : null ?> type="radio" id="spesialistht_tl_weber_telinga_kanan_1" name="SpesialisTht[tl_weber_telinga_kanan]" value="Lateralisasi Kanan">
                                    Lateralisasi Kanan
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_weber_telinga_kiri',  ['id' => 'spesialistht_tl_weber_telinga_kiri_0', 'value' => 'Tidak Ada Lateralisasi', 'label' => 'Tidak Ada Lateralisasi']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_weber_telinga_kiri == 'Lateralisasi Kiri') ? 'checked' : null ?> type="radio" id="spesialistht_tl_weber_telinga_kiri_1" name="SpesialisTht[tl_weber_telinga_kiri]" value="Lateralisasi Kiri">
                                    Lateralisasi Kiri
                                </label>
                            </td>
                        </tr>
                        <tr class="tr_test_garpu_tala" style="<?= $model->tl_test_garpu_tala_periksa == 'Tidak' ? 'display: none' : null ?>">
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_swabach_telinga_kanan',  ['id' => 'spesialistht_tl_swabach_telinga_kanan_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_swabach_telinga_kanan == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_tl_swabach_telinga_kanan_1" name="SpesialisTht[tl_swabach_telinga_kanan]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_swabach_telinga_kiri',  ['id' => 'spesialistht_tl_swabach_telinga_kiri_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_swabach_telinga_kiri == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_tl_swabach_telinga_kiri_1" name="SpesialisTht[tl_swabach_telinga_kiri]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                        </tr>
                        <tr class="tr_test_garpu_tala" style="<?= $model->tl_test_garpu_tala_periksa == 'Tidak' ? 'display: none' : null ?>">
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_swabach_telinga_kanan == 'Memendek') ? 'checked' : null ?> type="radio" id="spesialistht_tl_swabach_telinga_kanan_2" name="SpesialisTht[tl_swabach_telinga_kanan]" value="Memendek">
                                    Memendek
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_swabach_telinga_kanan == 'Memanjang') ? 'checked' : null ?> type="radio" id="spesialistht_tl_swabach_telinga_kanan_3" name="SpesialisTht[tl_swabach_telinga_kanan]" value="Memanjang">
                                    Memanjang
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_swabach_telinga_kiri == 'Memendek') ? 'checked' : null ?> type="radio" id="spesialistht_tl_swabach_telinga_kiri" name="SpesialisTht[tl_swabach_telinga_kiri]" value="Memendek">
                                    Memendek
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_swabach_telinga_kiri == 'Memanjang') ? 'checked' : null ?> type="radio" id="spesialistht_tl_swabach_telinga_kiri" name="SpesialisTht[tl_swabach_telinga_kiri]" value="Memanjang">
                                    Memanjang
                                </label>
                            </td>
                        </tr>
                        <tr class="tr_test_garpu_tala" style="<?= $model->tl_test_garpu_tala_periksa == 'Tidak' ? 'display: none' : null ?>">
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_bing_telinga_kanan',  ['id' => 'spesialistht_tl_bing_telinga_kanan_0', 'value' => 'Bertambah Keras', 'label' => 'Bertambah Keras']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_bing_telinga_kanan == 'Tidak Bertambah Keras') ? 'checked' : null ?> type="radio" id="spesialistht_tl_bing_telinga_kanan_1" name="SpesialisTht[tl_bing_telinga_kanan]" value="Tidak Bertambah Keras">
                                    Tidak Bertambah Keras
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tl_bing_telinga_kiri',  ['id' => 'spesialistht_tl_bing_telinga_kiri_0', 'value' => 'Bertambah Keras', 'label' => 'Bertambah Keras']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tl_bing_telinga_kiri == 'Tidak Bertambah Keras') ? 'checked' : null ?> type="radio" id="spesialistht_tl_bing_telinga_kiri_1" name="SpesialisTht[tl_bing_telinga_kiri]" value="Tidak Bertambah Keras">
                                    Tidak Bertambah Keras
                                </label>
                            </td>
                        </tr>
                        ...
                        <tr style="<?= $model->tl_test_berbisik_periksa == 'Tidak' ? 'display: none' : null ?>" class="tr_test_berbisik">
                            ...
                            $('#spesialistht-tl_test_berbisik_telinga_kanan').val(optionBerbisik[dipilih]).trigger('change')
                        }",
                                    ],
                                ])->label(false);
                            ...
                            $('#spesialistht-tl_test_berbisik_telinga_kiri').val(optionBerbisik[dipilih]).trigger('change')
                        }",
                                    ],
                                ])->label(false);
                            ...
                            <!-- <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                <label>
                    <input <?= ($model->tl_test_berbisik_telinga_kanan_6 == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_tl_test_berbisik_telinga_kanan_1" name="SpesialisTht[tl_test_berbisik_telinga_kanan_6]" value="Tidak Normal">
                    Tidak Normal
                </label>
            </td>
            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                <?= Html::activeRadio($model, 'tl_test_berbisik_telinga_kiri_6',  ['id' => 'spesialistht_tl_test_berbisik_telinga_kiri_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
            </td>
            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                <label>
                    <input <?= ($model->tl_test_berbisik_telinga_kiri_6 == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_tl_test_berbisik_telinga_kiri_1" name="SpesialisTht[tl_test_berbisik_telinga_kiri_6]" value="Tidak Normal">
                    Tidak Normal
                </label>
            </td> -->
                        </tr>
            ...
            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=top>
                <font color="#000000"><br></font>
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'hd_meatus_nasi',  ['id' => 'spesialistht_hd_meatus_nasi_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->hd_meatus_nasi == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_hd_meatus_nasi_1" name="SpesialisTht[hd_meatus_nasi]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top colspan="3">
                                <label>
                                    <input <?= ($model->hd_septum_nasi == 'Deviasi ke') ? 'checked' : null ?> type="radio" id="hd_septum_nasi_1" name="SpesialisTht[hd_septum_nasi]" value="Deviasi ke">
                                    Deviasi ke ...
                                </label>
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top colspan="3">
                                <label>
                                    <input <?= ($model->hd_konka_nasal == 'Oedema Lubang Hidung') ? 'checked' : null ?> type="radio" id="hd_konka_nasal_1" name="SpesialisTht[hd_konka_nasal]" value="Oedema Lubang Hidung">
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top colspan="3">
                                <label>
                                    <input <?= ($model->hd_nyeri_ketok_sinus_maksilar == 'Nyeri Tekan Positif di') ? 'checked' : null ?> type="radio" id="hd_nyeri_ketok_sinus_maksilar_1" name="SpesialisTht[hd_nyeri_ketok_sinus_maksilar]" value="Nyeri Tekan Positif di">
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'hd_penciuman',  ['id' => 'spesialistht_hd_penciuman_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->hd_penciuman == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_hd_penciuman_1" name="SpesialisTht[hd_penciuman]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tg_pharynx',  ['id' => 'spesialistht_tg_pharynx_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tg_pharynx == 'Hiperemis') ? 'checked' : null ?> type="radio" id="spesialistht_tg_pharynx_1" name="SpesialisTht[tg_pharynx]" value="Hiperemis">
                                    Hiperemis
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tg_pharynx == 'Granulasi') ? 'checked' : null ?> type="radio" id="spesialistht_tg_pharynx_2" name="SpesialisTht[tg_pharynx]" value="Granulasi">
                                    Granulasi
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tg_ukuran_kanan',  ['id' => 'spesialistht_tg_ukuran_kanan_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tg_ukuran_kanan == 'Hiperemis') ? 'checked' : null ?> type="radio" id="spesialistht_tg_ukuran_kanan_1" name="SpesialisTht[tg_ukuran_kanan]" value="Hiperemis">
                                    Hiperemis
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tg_ukuran_kiri',  ['id' => 'spesialistht_tg_ukuran_kiri_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tg_ukuran_kiri == 'Hiperemis') ? 'checked' : null ?> type="radio" id="spesialistht_tg_ukuran_kiri_1" name="SpesialisTht[tg_ukuran_kiri]" value="Hiperemis">
                                    Hiperemis
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <?= Html::activeRadio($model, 'tg_palatum',  ['id' => 'spesialistht_tg_palatum_0', 'value' => 'Normal', 'label' => 'Normal']) ?>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tg_palatum == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="spesialistht_tg_palatum_1" name="SpesialisTht[tg_palatum]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
