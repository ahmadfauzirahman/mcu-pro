 ...
 * @Last Modified time: 2021-03-13 14:25:24
 */


$(document).ready(function () {

    $('#spesialismata-kesan').on('change', function (e) {
        let kesan = $('#SpesialisMata_kesan_0').prop('checked')
        console.log(kesan);
        if (kesan)
    ...
    $("#form-spesialis-mata").on('submit', function (e) {
        ...
        $.post(baseUrl + 'spesialis-mata/periksa?id=' + $('#spesialismata-cari_pasien').val(), kepalaform, function (r) {
            console.log(r)
            if (r.s) {
    ...
    $("#form-spesialis-mata-penata").on('submit', function (e) {
        ...
        $.post(baseUrl + 'spesialis-mata/simpan-penata?id=' + $('#spesialismata-id_spesialis_mata').val(), kepalaform, function (r) {
            console.log(r)
            if (r.s) {
                $.pjax.reload({container: '#btn-cetak-penata', async: false})
