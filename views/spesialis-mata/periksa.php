                ...
                <div class="mcu-spesialis-audiometri-form">
                    ...
                    <table class="table table-sm tabel-mata">
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->persepsi_warna_mata_kanan == 'Buta Warna Parsial') ? 'checked' : null ?> type="radio" id="mcuspesialismata_persepsi_warna_mata_kanan_1" name="SpesialisMata[persepsi_warna_mata_kanan]" value="Buta Warna Parsial">
                                    Buta Warna Parsial
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->persepsi_warna_mata_kiri == 'Buta Warna Parsial') ? 'checked' : null ?> type="radio" id="mcuspesialismata_persepsi_warna_mata_kiri_1" name="SpesialisMata[persepsi_warna_mata_kiri]" value="Buta Warna Parsial">
                                    Buta Warna Parsial
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->persepsi_warna_mata_kanan == 'Buta Warna Total') ? 'checked' : null ?> type="radio" id="mcuspesialismata_persepsi_warna_mata_kanan_2" name="SpesialisMata[persepsi_warna_mata_kanan]" value="Buta Warna Total">
                                    Buta Warna Total
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->persepsi_warna_mata_kiri == 'Buta Warna Total') ? 'checked' : null ?> type="radio" id="mcuspesialismata_persepsi_warna_mata_kiri_2" name="SpesialisMata[persepsi_warna_mata_kiri]" value="Buta Warna Total">
                                    Buta Warna Total
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->kelopak_mata_kanan == 'Tidak Normal (Oedema)') ? 'checked' : null ?> type="radio" id="mcuspesialismata_kelopak_mata_kanan_1" name="SpesialisMata[kelopak_mata_kanan]" value="Tidak Normal (Oedema)">
                                    Tidak Normal (Oedema)
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->kelopak_mata_kiri == 'Tidak Normal (Oedema)') ? 'checked' : null ?> type="radio" id="mcuspesialismata_kelopak_mata_kiri_1" name="SpesialisMata[kelopak_mata_kiri]" value="Tidak Normal (Oedema)">
                                    Tidak Normal (Oedema)
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->konjungtiva_mata_kanan == 'Hiperemesis') ? 'checked' : null ?> type="radio" id="mcuspesialismata_konjungtiva_mata_kanan_1" name="SpesialisMata[konjungtiva_mata_kanan]" value="Hiperemesis">
                                    Hiperemesis
                                </label>
                                <label style="margin-left: 20px;">
                                    <input <?= ($model->konjungtiva_mata_kanan == 'Sekret (-)') ? 'checked' : null ?> type="radio" id="mcuspesialismata_konjungtiva_mata_kanan_2" name="SpesialisMata[konjungtiva_mata_kanan]" value="Sekret (-)">
                                    Sekret
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->konjungtiva_mata_kiri == 'Hiperemesis') ? 'checked' : null ?> type="radio" id="mcuspesialismata_konjungtiva_mata_kiri_1" name="SpesialisMata[konjungtiva_mata_kiri]" value="Hiperemesis">
                                    Hiperemesis
                                </label>
                                <label style="margin-left: 20px;">
                                    <input <?= ($model->konjungtiva_mata_kiri == 'Sekret (-)') ? 'checked' : null ?> type="radio" id="mcuspesialismata_konjungtiva_mata_kiri_2" name="SpesialisMata[konjungtiva_mata_kiri]" value="Sekret (-)">
                                    Sekret
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->konjungtiva_mata_kanan == 'Pucat') ? 'checked' : null ?> type="radio" id="mcuspesialismata_konjungtiva_mata_kanan_3" name="SpesialisMata[konjungtiva_mata_kanan]" value="Pucat">
                                    Pucat
                                </label>
                                <label style="margin-left: 20px;">
                                    <input <?= ($model->konjungtiva_mata_kanan == 'Pterigium') ? 'checked' : null ?> type="radio" id="mcuspesialismata_konjungtiva_mata_kanan_4" name="SpesialisMata[konjungtiva_mata_kanan]" value="Pterigium">
                                    Pterigium
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->konjungtiva_mata_kiri == 'Pucat') ? 'checked' : null ?> type="radio" id="mcuspesialismata_konjungtiva_mata_kiri_3" name="SpesialisMata[konjungtiva_mata_kiri]" value="Pucat">
                                    Pucat
                                </label>
                                <label style="margin-left: 20px;">
                                    <input <?= ($model->konjungtiva_mata_kiri == 'Pterigium') ? 'checked' : null ?> type="radio" id="mcuspesialismata_konjungtiva_mata_kiri_4" name="SpesialisMata[konjungtiva_mata_kiri]" value="Pterigium">
                                    Pterigium
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->kesegarisan_gerak_bola_mata_kanan == 'Strabismus') ? 'checked' : null ?> type="radio" id="mcuspesialismata_kesegarisan_gerak_bola_mata_kanan_1" name="SpesialisMata[kesegarisan_gerak_bola_mata_kanan]" value="Strabismus">
                                    Strabismus
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->kesegarisan_gerak_bola_mata_kiri == 'Strabismus') ? 'checked' : null ?> type="radio" id="mcuspesialismata_kesegarisan_gerak_bola_mata_kiri_1" name="SpesialisMata[kesegarisan_gerak_bola_mata_kiri]" value="Strabismus">
                                    Strabismus
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->skiera_mata_kanan == 'Ikterik') ? 'checked' : null ?> type="radio" id="mcuspesialismata_skiera_mata_kanan_1" name="SpesialisMata[skiera_mata_kanan]" value="Ikterik">
                                    Ikterik
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->skiera_mata_kiri == 'Ikterik') ? 'checked' : null ?> type="radio" id="mcuspesialismata_skiera_mata_kiri_1" name="SpesialisMata[skiera_mata_kiri]" value="Ikterik">
                                    Ikterik
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->lensa_mata_kanan == 'Keruh') ? 'checked' : null ?> type="radio" id="mcuspesialismata_lensa_mata_kanan_1" name="SpesialisMata[lensa_mata_kanan]" value="Keruh">
                                    Keruh
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->lensa_mata_kiri == 'Keruh') ? 'checked' : null ?> type="radio" id="mcuspesialismata_lensa_mata_kiri_1" name="SpesialisMata[lensa_mata_kiri]" value="Keruh">
                                    Keruh
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->kornea_mata_kanan == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="mcuspesialismata_kornea_mata_kanan_1" name="SpesialisMata[kornea_mata_kanan]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->kornea_mata_kiri == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="mcuspesialismata_kornea_mata_kiri_1" name="SpesialisMata[kornea_mata_kiri]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->bulu_mata_kanan == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="mcuspesialismata_bulu_mata_kanan_1" name="SpesialisMata[bulu_mata_kanan]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->bulu_mata_kiri == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="mcuspesialismata_bulu_mata_kiri_1" name="SpesialisMata[bulu_mata_kiri]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tekanan_bola_mata_kanan == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="mcuspesialismata_tekanan_bola_mata_kanan_1" name="SpesialisMata[tekanan_bola_mata_kanan]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->tekanan_bola_mata_kiri == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="mcuspesialismata_tekanan_bola_mata_kiri_1" name="SpesialisMata[tekanan_bola_mata_kiri]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                        </tr>
                        <tr style="display: none;">
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->penglihatan_3_dimensi_mata_kanan == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="mcuspesialismata_penglihatan_3_dimensi_mata_kanan_1" name="SpesialisMata[penglihatan_3_dimensi_mata_kanan]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                            ...
                            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="left" valign=top>
                                <label>
                                    <input <?= ($model->penglihatan_3_dimensi_mata_kiri == 'Tidak Normal') ? 'checked' : null ?> type="radio" id="mcuspesialismata_penglihatan_3_dimensi_mata_kiri_1" name="SpesialisMata[penglihatan_3_dimensi_mata_kiri]" value="Tidak Normal">
                                    Tidak Normal
                                </label>
                            </td>
                        </tr>
