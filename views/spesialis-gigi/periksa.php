                        ...
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->oklusi, $oklusi_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_oklusi_3" name="SpesialisGigi[oklusi]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->oklusi, $oklusi_option)) ? $model->oklusi : null ?>" type="text" id="SpesialisGigi_oklusi_3_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->torus_palatinus, $torus_palatinus_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_torus_palatinus_5" name="SpesialisGigi[torus_palatinus]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->torus_palatinus, $torus_palatinus_option)) ? $model->torus_palatinus : null ?>" type="text" id="SpesialisGigi_torus_palatinus_5_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->torus_mandibularis, $torus_mandibularis_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_torus_mandibularis_4" name="SpesialisGigi[torus_mandibularis]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->torus_mandibularis, $torus_mandibularis_option)) ? $model->torus_mandibularis : null ?>" type="text" id="SpesialisGigi_torus_mandibularis_4_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->palatum, $palatum_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_palatum_3" name="SpesialisGigi[palatum]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->palatum, $palatum_option)) ? $model->palatum : null ?>" type="text" id="SpesialisGigi_palatum_3_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->supernumerary_teeth, $supernumerary_teeth_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_supernumerary_teeth_2" name="SpesialisGigi[supernumerary_teeth]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->supernumerary_teeth, $supernumerary_teeth_option)) ? $model->supernumerary_teeth : null ?>" type="text" id="SpesialisGigi_supernumerary_teeth_2_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->diastema, $diastema_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_diastema_2" name="SpesialisGigi[diastema]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->diastema, $diastema_option)) ? $model->diastema : null ?>" type="text" id="SpesialisGigi_diastema_2_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->spacing, $spacing_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_spacing_2" name="SpesialisGigi[spacing]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->spacing, $spacing_option)) ? $model->spacing : null ?>" type="text" id="SpesialisGigi_spacing_2_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->oral_hygiene, $oral_hygiene_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_oral_hygiene_3" name="SpesialisGigi[oral_hygiene]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->oral_hygiene, $oral_hygiene_option)) ? $model->oral_hygiene : null ?>" type="text" id="SpesialisGigi_oral_hygiene_3_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->gingiva_periodontal, $gingiva_periodontal_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_gingiva_periodontal_3" name="SpesialisGigi[gingiva_periodontal]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->gingiva_periodontal, $gingiva_periodontal_option)) ? $model->gingiva_periodontal : null ?>" type="text" id="SpesialisGigi_gingiva_periodontal_3_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->oral_mucosa, $oral_mucosa_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_oral_mucosa_2" name="SpesialisGigi[oral_mucosa]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->oral_mucosa, $oral_mucosa_option)) ? $model->oral_mucosa : null ?>" type="text" id="SpesialisGigi_oral_mucosa_2_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td style="border-top: 1px solid #ffffff; width: 100%; padding-left: 3% !important;">
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <div class="input-group-text">
                              <input <?= (!in_array($model->tongue, $tongue_option)) ? 'checked' : null ?> type="radio" id="SpesialisGigi_tongue_2" name="SpesialisGigi[tongue]">
                            </div>
                          </div>
                          <input value="<?= (!in_array($model->tongue, $tongue_option)) ? $model->tongue : null ?>" type="text" id="SpesialisGigi_tongue_2_teks" style="width: 50px;" class="form-control form-control-sm">
                        </div>
                      </td>
                    </tr>
                  </tbody>
