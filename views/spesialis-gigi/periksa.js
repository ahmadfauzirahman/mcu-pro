...
$(document).ready(function () {
  ...
  $("#McuSpesialisGigi_torus_palatinus_5_teks").on(
    "input change focus",
    function (e) {
  ...
  $("#McuSpesialisGigi_torus_mandibularis_4_teks").on(
    "input change focus",
    function (e) {
  ...
  $("#McuSpesialisGigi_supernumerary_teeth_2_teks").on(
    "input change focus",
    function (e) {
  ...
  $("#McuSpesialisGigi_oral_hygiene_3_teks").on(
    "input change focus",
    function (e) {
  ...
  $("#McuSpesialisGigi_gingiva_periodontal_3_teks").on(
    "input change focus",
    function (e) {
  ...
  $("#McuSpesialisGigi_oral_mucosa_2_teks").on(
    "input change focus",
    function (e) {
  ...
  $("#form-spesialis-gigi").on("submit", function (e) {
    ...
    $.post(
      baseUrl +
        "spesialis-gigi/periksa?id=" +
        $("#mcuspesialisgigi-cari_pasien").val(),
      kepalaform,
      function (r) {
        console.log(r);
        if (r.s) {
  ...
  $("#form-spesialis-gigi-penata").on("submit", function (e) {
    ...
    $.post(
      baseUrl +
        "spesialis-gigi/simpan-penata?id=" +
        $("#mcuspesialisgigi-id_spesialis_gigi").val(),
      kepalaform,
      function (r) {
        console.log(r);
        if (r.s) {
